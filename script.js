function generate(){
    var quotes = {
        ...
        "-Petrach":'" True, we love life, not because we are used to living, but because we are used to loving.<br> There is always some madness in love, but there is also always some reason in madness."',
        "-Muhammed Ali": '"Don’t quit. Suffer now and live the rest of your life as a champion."',
        "-Chico Xavier":'"Though nobody can go back and make a new beginning… <br> Anyone can start over and make a new ending.”',
